    ...
    def __init__(self, name, num_views, max_views):
        ...
        for i in range(1, num_views):
            ...
            def load_source_img(sample_dict, idx=i):
                ...
                assert (
                    key_idx == 0
                ), "This layout only works with samples where keyview_idx=0"
