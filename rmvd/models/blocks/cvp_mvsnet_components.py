...
def depth_regression(p, depth_values): # TODO: remove this as it is already implemented in mvsnet_components.py. Consider moving to a utils file.
...
def homo_warping(src_feature, ref_in, src_in, ref_ex, src_ex, depth_hypos): #TODO: How to unite all homography warping fucntions. 
